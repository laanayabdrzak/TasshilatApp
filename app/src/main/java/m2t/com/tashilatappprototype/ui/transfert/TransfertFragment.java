...
public class TransfertFragment extends Fragment implements AccountPaymentAdapter.AccountAdapterListener{
    ...
    private static final String TAG = TransfertFragment.class.getSimpleName();
    ...
    public static TransfertFragment newInstance(int page, String title) {
        TransfertFragment  third = new TransfertFragment ();
    ...
    private void prepareAccounts() {
        ...
        Merchant merchant;
        for (Operator op :db.getOperatorByCategorie("transfert")) {
