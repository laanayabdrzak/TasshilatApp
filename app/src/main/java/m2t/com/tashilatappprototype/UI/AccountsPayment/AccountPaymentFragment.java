...
public class AccountPaymentFragment extends Fragment {
    ...
    private void showMyDialog(Context context) {
        ...
        dialog.setContentView(R.layout.add_account_payment_dialog);
    ...
    private void setUpItemTouchHelper() {
        ...
        ItemTouchHelper.SimpleCallback simpleItemTouchCallback = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
            ...
            public int getSwipeDirs(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
                ...
                AccountPaymentAdapter testAdapter = (AccountPaymentAdapter) recyclerView.getAdapter();
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int swipeDir) {
                ...
                AccountPaymentAdapter adapter = (AccountPaymentAdapter) recyclerView.getAdapter();
